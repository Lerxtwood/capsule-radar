...
void ui_set_map_background(bool enabled); // toggle extra HUD readability plates when the radar map is on
...
void ui_set_app_switch_cb(void (*cb)(void)); // top-center radar tap -> notify main
void ui_set_firmware_switch_cb(void (*cb)(void)); // Printer button -> external firmware slot
